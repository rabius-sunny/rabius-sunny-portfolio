    ...
    <div className='grid grid-cols-1 my-10 lg:my-20 lg:grid-cols-2 gap-8 lg:gap-4 justify-items-center'>
      <div className='col-auto text-center lg:text-start'>
        ...
        <p className='font-medium text-justify lg:text-start'>
          ...
          environments, finding solutions and determining customer satisfaction.
          Designed and developed web applications across the latest technologies
          and tools, multiple APIs, third-party integrations and databases
          meeting the highest standards, best practices and speed.
        </p>
